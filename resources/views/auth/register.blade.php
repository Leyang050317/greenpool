                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="mb-4" x-data="{ 
                        ...
                        <div class="relative mt-1">
                            <input id="password" :type="showPassword ? 'text' : 'password'" name="password" x-model="password" required autocomplete="new-password" placeholder="••••••••" class="block w-full border border-gray-300 rounded-md p-2.5 focus:border-green-600 focus:ring-green-600" />
                        ...
                        <div x-show="password.length > 0" x-cloak class="mt-2">
                            <div class="flex items-center justify-between mb-1">
                                ...
                                <span class="text-xs font-bold"
                                      ...
                                      x-text="strength === 1 ? 'Weak' : (strength === 2 ? 'Medium' : 'Strong')">
                                </span>
                            </div>
                            <div class="flex gap-1 h-1.5">
                                <div class="flex-1 rounded-full transition-colors duration-300" :class="strength >= 1 ? (strength === 1 ? 'bg-red-500' : (strength === 2 ? 'bg-yellow-500' : 'bg-green-500')) : 'bg-gray-200'"></div>
                                <div class="flex-1 rounded-full transition-colors duration-300" :class="strength >= 2 ? (strength === 2 ? 'bg-yellow-500' : 'bg-green-500') : 'bg-gray-200'"></div>
                                <div class="flex-1 rounded-full transition-colors duration-300" :class="strength === 3 ? 'bg-green-500' : 'bg-gray-200'"></div>
                            </div>
                        </div>
                        <p x-show="password.length === 0" class="text-xs text-gray-400 mt-1">Use at least 8 characters.</p>

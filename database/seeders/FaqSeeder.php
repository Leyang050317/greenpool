...
class FaqSeeder extends Seeder
{
    public function run(): void
    {
        foreach ([
            ...
            ['What can the GreenPool Help Bot answer?', 'The Help Bot can provide general guidance and explain approved GreenPool topics such as trips, bookings, payments, messages, ratings, notifications, vehicles, account setup, and attractions. GreenPool-specific answers are based on approved FAQ content. It does not access private account details or make bookings for you.', ['help bot', 'faq bot', 'chatbot', 'bot privacy'], 'Help', false, 28],
